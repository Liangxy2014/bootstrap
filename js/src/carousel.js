...
const Carousel = (($) => {
  ...
  class Carousel {
    ...
    pause(event) {
      ...
      if (SelectorEngine.find(this._element, Selector.NEXT_PREV)[0] &&
    ...
    to(index) {
      this._activeElement = SelectorEngine.find(this._element, Selector.ACTIVE_ITEM)[0]
    ...
    _triggerSlideEvent(relatedTarget, eventDirectionName) {
      ...
      const fromIndex   = this._getItemIndex(SelectorEngine.find(this._element, Selector.ACTIVE_ITEM)[0])
